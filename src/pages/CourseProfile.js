...
class CourseProfile extends Component {
    ...
    onInputchange(event) {
        ...
        let temp = {...this.state.course, [event.target.name]:event.target.value};
        this.setState({course:temp})
    ...
    saveData()
    {
        ...
        let url="http://localhost:5000/api/courses/"+ this.state.course.course_ID
        ...
        let url1= "http://localhost:5000/api/courses/"+ this.state.course.course_ID;
                ...
                <div className="outer-div">
                           ...
                           <div>
                               ...
                               <div className="inner-div">
                                   ...
                                   <p className="student-data-p">{this.state.course.offered_in_sem}</p>
                               </div>

                               <div className="inner-div">
                                   <h3 className="labels">COMPULSARY: </h3>
                                   <p className="student-data-p">{this.state.course.is_compulsory}</p>
                               </div>
            ...
            return(
                ...
                <h1>Course Profile</h1>
                    ...
                    <div>
                        <div className="inner-div">
                            <h3 className="labels">COURSE NAME: </h3>
                            <input name="name" className="input-fields" defaultValue={this.state.course.name} type="input" onChange={this.onInputchange}></input>
                    ...
                    <div>
                        <div className="inner-div">
                            <h3 className="labels">INSTRUCTOR: </h3>
                            <input  name="instructor"className="input-fields" defaultValue={this.state.course.instructor} type="text" onChange={this.onInputchange}></input>
                        </div>
                    </div>
                    ...
                    <div>
                        <div className="inner-div">
                            <h3 className="labels">OFFERED IN SEMESTER: </h3>
                                ...
                                <select name="offered_in_sem" className="inputs-fields" required onChange={this.onInputchange}>
                                <option value="" selected disabled hidden>{this.state.course.offered_in_sem}</option>
                    ...
                    <div>
                        <div className="inner-div">
                            <h3 className="labels">COMPULSARY: </h3>
                                ...
                                <select name="is_compulsory" className="inputs-fields" required onChange={this.onInputchange}>

                                    <option value="" selected disabled hidden>{this.state.course.is_compulsory}</option>

                                    <option id="compulsory" value="true">Yes (for core courses)</option>
                                    <option id="compulsory" value="false">No (for elective courses)</option>
                    ...
                    <div>
                        <div className="inner-div">
                            <h3 className="labels">DEPARTMENT: </h3>
                                ...
                                <select name="department" className="inputs-fields" required onChange={this.onInputchange}>
                                    <option value="" selected disabled hidden>{this.state.course.department}</option>
