...
class StudentProfile extends Component {
    ...
    deleteCourse (courseid)
    {
        ...
        let url="http://localhost:5000/api/studentCourses/"+ this.state.student.roll_number +"/" + courseid
    ...
    saveData()
    {
        ...
        let url="http://localhost:5000/api/students/"+ this.state.student.roll_number
    ...
    onInputchange(event) {
        ...
        let temp = {...this.state.student, [event.target.name]:event.target.value};
    ...
    courseAdd(event)
    {
        this.setState({new_course:{roll_number: this.state.student.roll_number, course_ID:event.target.value }})

        console.log(this.state.new_course)
    }
 ...
 render() {
        ...
        {
            console.log(this.state.student.roll_number)
            ...
            return(
                ...
                <h1>Student Profile</h1>
                    ...
                    <div>
                        <div className="inner-div">
                            <h3 className="labels">NAME: </h3>
                            <input name="name"  className="input-fields" defaultValue={this.state.student.name} type="input" onChange={this.onInputchange}></input>
                        </div>
                    </div>
                    ...
                    <div>
                        <div className="inner-div">
                            ...
                            <input name="dob" className="input-fields" defaultValue={this.state.student.dob} type="date" onChange={this.onInputchange}></input>
                        </div>
                    </div>
                    ...
                    <div>
                        <div className="inner-div">
                            <h3 className="labels">ADDRESS: </h3>
                            <input  name="address" className="input-fields" defaultValue={this.state.student.address} type="text" onChange={this.onInputchange}></input>
                        </div>
                    </div>
                    ...
                    <div>
                        <div className="inner-div">
                            <h3 className="labels">SEMESTER: </h3>
                                ...
                                <select name="semester" className="inputs-field" required onChange={this.onInputchange}>
                                    <option value="" selected disabled hidden>{this.state.student.semester}</option>
                    ...
                    <div>
                        <div className="inner-div">
                            <h3 className="labels">WARNING: </h3>
                                ...
                                <select name="warnings" className="inputs-field" required onChange={this.onInputchange}>

                                    <option value="" selected disabled hidden>{this.state.student.warnings}</option>
                    ...
                    <div>
                        <div className="inner-div">
                            <h3 className="labels">CGPA: </h3>
                            <input name="cgpa" className="input-fields" defaultValue={this.state.student.cgpa} type="text" onChange={this.onInputchange}></input>
                        </div>
                    </div>
                                    ...
                                    </tr>
                                    {
                                        ...
                                        <tr className="table-courses">
                                            ...
                                            <td className="table-row">
                                                <button className="delete-button" onClick={()=>this.deleteCourse(item.course_ID)} >
                    ...
                    <div className="add-course-button"> Add Course
                                        <div className="inner-div">
                                                <button className="table-row" onClick={this.postCourse}>
                                                    <FontAwesomeIcon icon={faPlus} />
                                                </button>

                                                <input name="new_course" className="input-fields" placeholder="Enter course ID" type="text" onChange={this.courseAdd} ></input>
