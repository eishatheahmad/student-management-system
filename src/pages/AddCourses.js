          ...
          <form class="my-form">
            ...
            <div className="icon-div">
              ...
              <input
                ...
                className="inputs"
                name="course_ID"
                placeholder="Enter Course ID i.e. CS000"
                required
            ...
            <div className="icon-div">
              ...
              >
                ...
                <option id="compulsory" value="0">
                  Yes (for core courses)
                </option>
                <option id="compulsory" value="1">
            ...
            <div className="icon-div">
              ...
              >
                ...
                <option id="dept" value="CS">
                  CS
                </option>
                <option id="dept" value="EE">
                  EE
                </option>
                <option id="dept" value="CV">
                  CV
                </option>
                <option id="dept" value="MG">
                  MG
                </option>
              </select>
            </div>
            ...
            >
              <button
                ...
                onClick={this.addNewCourse.bind(this)}
              >
                Add Course
              </button>
            </Link>
